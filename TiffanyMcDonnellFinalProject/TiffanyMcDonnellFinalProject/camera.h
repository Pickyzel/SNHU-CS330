...
enum Camera_Movement {
    ...
    LEFT,
    RIGHT,
    UP,//Had to add UP and DOWN for UPWARD and DOWNWARD motions
    DOWN
};
...
public:
    ...
    void ProcessKeyboard(Camera_Movement direction, float deltaTime)
    {
        ...
        if (direction == RIGHT)
            Position += Right * velocity;
        if (direction == UP)/////Added +=Up
            Position += Up * velocity;
        if (direction == DOWN)/////Added -=Up
            Position -= Up * velocity;
    }
    ...
    {
        MovementSpeed += (float)yoffset;//Changed Zoom to MovementSpeed
